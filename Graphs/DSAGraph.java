...
public class DSAGraph
{
    private class DSAGraphVertex
    {
        ...
        /** Private Classfields **/
        private String label; // Key for the vertex
        private DSALinkedList links; // Adjacency list
        private boolean visited; // Used for traversal
    ...
    */
    ...
    {
        int numVerticies = getVertexCount(); // Number of verticies in graph
        DSAGraphVertex[] arr; // Array of all verticies in graph
        int[][] matrix; // 2D array of matrix, uses 0's for no adjacency and 1's for adjacency
        int idx = 0;// index used to fill arr
    ...
    */
    ...
    private String DFSRec(DSAGraphVertex vertex)
    {
        ...
        for(Object o : vertex.getAdjacent())
        {
            ...
            {
                out += ("(" + vertex.toString() + ", " + subVertex.toString() + ")" + DFSRec(subVertex ));// Recurse
            }
        }
    ...
    */ 
    ...
    {
        DSAGraphVertex vertex = (DSAGraphVertex)queue.dequeue();// Current vertex for this recurse
        DSAGraphVertex subVertex;// Current vertex in adjacency list of vertex for each iteration
        String out = "";// Export string
        ...
        for(Object o : vertex.getAdjacent())
        {
            ...
            if(!subVertex.getVisited())
            {
                ...
                out += ("(" + vertex.toString() + ", " + subVertex.toString() + ")  ");
            }
        }
    ...
    */
    public void addEdge(DSAGraphVertex vertex1, DSAGraphVertex vertex2)
    {
        ...
        {
            throw new IllegalArgumentException("Verticies " + vertex1 + " and " + vertex2 + " are already connected");
        }
    ...
    */
    public void loadFile(String fileName)
    {
        ...
        BufferedReader bfr;
        DSALinkedList lines = new DSALinkedList(); // List of lines in file as strings
        String line;
        String[] edgeVerticies = new String[2]; // 2-element array of the verticies at each end of given edge
        ...
        catch(IOException e)
        {
            ...
            {
                throw new IllegalArgumentException("Error in file reading");
            }
        }
        ...
        for(Object o : lines)
        {
            edgeVerticies = ((String)o).split(" ");// Populate the array with the verticies on either side of 
