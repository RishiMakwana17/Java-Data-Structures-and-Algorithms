...
public class DSAHashTable
{
    ...
    */
    public Object get(String inKey)
    {
        ...
        //AssetFile[] temporaryAsset = new AssetFile[asset.length]; 
        while( !found && !giveUp )
        {
    ...
    public void displayTrades(String inKey)
    {
        int keyLength = inKey.length();
        int length = keyLength;
        try
        {
            Scanner sc = new Scanner(System.in);
            JSONTokener token = new JSONTokener(new FileReader("24hrJSON.JSON"));
            JSONArray symbols = new JSONArray(token);
            for(int i = 0;i < inKey.length();i++)
            {
                String symbol = symbols.getJSONObject(i).getString("symbol"); 
                System.out.println("Enter the asset name you would like to display: ");
                String get = sc.nextLine();
                if (symbol.equals(get))
                {
                System.out.println("Symbol: ");
                System.out.println(symbols.getJSONObject(i).getString("symbol"));
                System.out.println("Price Change Percentage: ");
                System.out.println(symbols.getJSONObject(i).getString("priceChangePercent"));
                System.out.println("Previous Close Price: ");
                System.out.println(symbols.getJSONObject(i).getString("prevClosePrice"));
                System.out.println("Last Price: ");
                System.out.println(symbols.getJSONObject(length).getString("lastPrice"));
                System.out.println("Last Qty: ");
                System.out.println(symbols.getJSONObject(length).getString("lastQty"));
                System.out.println("Bid Price: ");
                System.out.println(symbols.getJSONObject(length).getString("bidPrice"));
                System.out.println("Bid Qty: ");
                System.out.println(symbols.getJSONObject(length).getString("bidQty"));
                System.out.println("Ask Price: ");
                System.out.println(symbols.getJSONObject(length).getString("askPrice"));
                System.out.println("Ask Qty: ");
                System.out.println(symbols.getJSONObject(length).getString("askQty"));
                System.out.println("Open Price: ");
                System.out.println(symbols.getJSONObject(length).getString("openPrice"));
                System.out.println("High Price: ");
                System.out.println(symbols.getJSONObject(length).getString("highPrice"));
                System.out.println("Low Price: ");
                System.out.println(symbols.getJSONObject(length).getString("lowPrice"));
                System.out.println("Volume: ");
                System.out.println(symbols.getJSONObject(length).getString("volume"));
                System.out.println("Count: ");
                System.out.println(symbols.getJSONObject(length).getInt("count"));
            }
            else if(symbol != get)
            {
                System.out.println("Please enter a valid asset");
            }           
            }
        }
        catch(Exception e)
    ...
    */
    public boolean hasKey( String inKey )
    {
        ...
        {
            exists = true;
            System.out.println("Present bitches");
        }
        else
        {
