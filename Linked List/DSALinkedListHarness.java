...
public class DSALinkedListHarness
{
    ...
    public static void save(DSALinkedList objToSave, String fileName) // Saves linked list object to file using seralization
    {
        FileOutputStream fileStrm; // File IO object
        ObjectOutputStream objStrm;// Serialization object
    ...
    public static DSAQueue load(String fileName) //Loads linked list from file using serialization
    {
        FileInputStream fileStrm; // File IO object
        ObjectInputStream objStrm; // Serialization object
        DSAQueue inObj = null;// Linked list object to load to

        try
        {
            fileStrm = new FileInputStream(fileName); // Underlying stream
  
            objStrm = new ObjectInputStream(fileStrm); // Object Seralization Stream
            inObj = (DSAQueue)objStrm.readObject(); // Deserialize

            objStrm.close(); // Clean up
        }
        catch(ClassNotFoundException e)
        {
            throw new IllegalArgumentException("DSALinkedList class not found " + e.getMessage());
        }
        catch(IOException e)
        {
            throw new IllegalArgumentException("Successfully Read Seralized File");
            //e.printStackTrace();
        }
    ...
    public static DSAQueue loadListUI(DSAQueue Queue)
    {
        String fileName;
        Scanner sc = new Scanner( System.in );
